export const searchComponent = `    
          <div
            class="relative left-4 md:static md:left-0 max-sm:h-[47px] search_form mt-6 md:mt-[116px] xl:mt-[140px] mx-auto w-[80%] md:w-[549px] xl:w-[50%] max-w-[1106px] flex justify-between items-center px-6 py-[18px] md:px-0 md:py-0 bg-[#FFEDF4] dark:bg-[#333333] text-[#8A8A8A] dark:text-[#B0B0B0] text-xs md:text-sm 2xl:text-xl rounded-[90px] search-container md:bg-inherit md:dark:bg-inherit"
          >
