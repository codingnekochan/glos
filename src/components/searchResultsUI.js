...
const searchResultComponent = `<div
          ...
          <div
            class="entry-word_synonym lg:overflow-auto col-span-2 row-span-2 xl:col-span-2 xl:row-span-2 p-4 lg:p-6 lg:mx-4 lg:mb-2 xl:mx-12 2xl:ml-24 2xl:mr-32 border border-[#FFD1E140] rounded-[20px] shadow-[1px_1px_4px_0_rgba(255,209,225,0.25)]"
          >
            <h3
          ...
          <div
            class="entry-word_antonym lg:overflow-auto col-span-2 row-span-2 xl:col-span-2 xl:row-span-2 p-4 lg:p-6 lg:mx-4 lg:mt-2 xl:mx-12 2xl:ml-24 2xl:mr-32 border border-[#FFD1E140] rounded-[20px] shadow-[1px_1px_4px_0_rgba(255,209,225,0.25)]"
          >
            <h3
              class="antonyms font-bold border-b-2 border-black dark:border-white mx-auto text-center text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-[33px] dark:text-[##F8E9EE] pb-1"
            >
