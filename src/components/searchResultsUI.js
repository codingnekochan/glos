...
const searchResultComponent = `<div
          ...
          >
            <div
              class="searched-word flex justify-between max-[375px]:gap-0 max-[375px]:flex-wrap gap-3 items-center px-2 mb-6 border-b-2 border-black dark:border-white dark:text-[#F8E9EE] pb-2 xl:pb-3 grid-cols-3"
            >
              <span
                class="entry-word font-['Oswald'] text-xl mr-3 lg:mr-10 md:text-2xl xl:text-3xl 2xl:text-[40px]"
                ></span
              >
              <span
                ...
                ></span
              >
              <div class=" button_container flex gap-5">
               <button class="play-audio relative">
                ...
                <div class= 'bookmark_button-container relative top-1'>      
                </div>
              </div>
            </div>
          ...
          <div
            class="entry-word_synonym overflow-auto col-span-2 row-span-2 xl:col-span-2 xl:row-span-2 p-4 lg:p-6 md:mx-4 lg:mb-2 xl:mx-12 2xl:ml-24 2xl:mr-32 border border-[#FFD1E140] rounded-[20px] shadow-[4px_4px_4px_0_rgba(255,209,225,0.5)] dark:shadow-[1px_1px_4px_0_rgba(255,209,225,0.25)]"
          >
            <h3
            ...
            <ul
              class="entry-word_synonyms--list px-5 py-3 text-sm md:text-base lg:text-lg 2xl:text-2xl"
            >
            </ul>
          </div>
          <div
            class="entry-word_antonym overflow-auto col-span-2 row-span-2 xl:col-span-2 xl:row-span-2 p-4 lg:p-6 md:mx-4 lg:mb-2 xl:mx-12 2xl:ml-24 2xl:mr-32 border border-[#FFD1E140] rounded-[20px] shadow-[4px_4px_4px_0_rgba(255,209,225,0.5)] dark:shadow-[1px_1px_4px_0_rgba(255,209,225,0.25)]"
          >
            <h3
              class="antonyms font-bold border-b-2 border-black dark:border-white mx-auto text-center text-base md:text-lg lg:text-xl xl:text-2xl 2xl:text-[33px] dark:text-[##F8E9EE] pb-1"
            >
            ...
            <ul
              class="entry-word_antonyms--list px-5 py-3 text-sm md:text-base lg:text-lg 2xl:text-2xl"
            >
            </ul>
          </div>`;
