let pageTemplate =` <section class="h-full page mt-24 md:mt-36 xl:mt-28">
        ...
        >
          You have not search for any word yet! Click on the search option or
          voice recording to look up a word!
        </p>
        <div
          class="hidden hidden_container md:ml-[163px] lg:mx-[31%] xl:mx-[31%]"
        >
          <ul
        ...
        <!-- modal box -->
        <div
          class="flex z-10 absolute w-full h-[100vh] top-0 left-0 bookmark_modal bg-[#00000099] justify-center items-center"
        >
          <div
          ...
          >
            ...
            <p
              class="px-8 mt-3 mb-6 font-bold text-center md:mt-2 md:mb-12 md:text-lg md:px-24 lg:text-2xl lg:px-20"
            >
